...
var eurecaServer = new Eureca.Server({
    allow: ['clientEcho', 'toggleLoadingScreen', 'showKeyboard', 'toggleDoneMessage']
});
...
eurecaServer.exports.addITunesPlaylist = function(playlist) {
    ...
    backend.addITunesPlaylist(playlist, function() {
        client.toggleLoadingScreen();
    });
}
...
eurecaServer.exports.importITunesMusic = function(playlist) {
    ...
    backend.importITunesMusic(playlist, true, function() {
        client.toggleLoadingScreen();
    });
}
...
eurecaServer.exports.syncMusic = function(loadMusicAfter) {
    ...
    backend.syncMusic(loadMusicAfter, function() {
        client.toggleLoadingScreen();
    });
}
...
eurecaServer.exports.setConfigValues = function(column, value, callback) {
    ...
    backend.setConfigValues(column, value, function() {
        client.toggleDoneMessage();
    });
}
